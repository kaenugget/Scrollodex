...
interface ContactMomentsFeedProps {
  contactId: Id<"contacts">;
  userId: Id<"users">;
}

export function ContactMomentsFeed({ contactId, userId }: ContactMomentsFeedProps) {
  ...
  return (
    <Card className="bg-white border-gray-200 overflow-hidden">
      ...
      <div className="p-4 space-y-3">
        ...
        {/* Caption */}
        {moment.caption && (
          <p className="text-gray-900 text-sm leading-relaxed">{moment.caption}</p>
        )}
