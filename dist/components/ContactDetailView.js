...
export function ContactDetailView({ contactId, userId, activeTab, onTabChange }) {
    ...
    const getRelationshipStats = () => {
        ...
        const connectionScore = Math.min(100, Math.max(20, baseScore +
        ...
        const reliabilityScore = Math.min(100, Math.max(20, baseScore +
        ...
        const communicationScore = Math.min(100, Math.max(20, baseScore +
        ...
        const energyScore = Math.min(100, Math.max(20, baseScore +
    ...
    return (<div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-8">
        ...
        <div className="lg:col-span-1 space-y-4 sm:space-y-6">
          ...
          {/* Pet Model */}
          <PetModel contactId={contactId} userId={userId} relationshipStats={relationshipStats} petData={contact.petData}/>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div className="bg-red-500 h-2 rounded-full transition-all duration-300" style={{ width: `${relationshipStats.connection}%` }}></div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div className="bg-blue-500 h-2 rounded-full transition-all duration-300" style={{ width: `${relationshipStats.reliability}%` }}></div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div className="bg-yellow-500 h-2 rounded-full transition-all duration-300" style={{ width: `${relationshipStats.communication}%` }}></div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div className="bg-orange-500 h-2 rounded-full transition-all duration-300" style={{ width: `${relationshipStats.energy}%` }}></div>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Dex Info Card */}
          {dexEntry && (<div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  {dexEntry.types.map(type => (<TypeChip key={type} type={type} size="sm"/>))}
                </div>
        ...
        <div className="lg:col-span-2 space-y-4 sm:space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4 sm:mb-6 gap-4">
              <div>
                ...
                {contact.location && (<div className="text-base sm:text-lg text-gray-500">{contact.location}</div>)}
              </div>
              <button onClick={handlePin} className={`p-3 rounded-full transition-colors ${contact.pinned
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2">
                {dexEntry && dexEntry.types.length > 0 ? (dexEntry.types.map(type => (<TypeChip key={type} type={type} size="md"/>))) : (<span className="px-4 py-2 bg-blue-600 text-white font-medium rounded-lg">Professional</span>)}
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                {contact.emails.length > 0 && (<div className="flex items-center gap-3">
                    <span className="text-gray-600 w-20">Email:</span>
                    <a href={`mailto:${contact.emails[0]}`} className="text-blue-600 hover:underline">
                      {contact.emails[0]}
                    </a>
                  </div>)}
                {contact.phones.length > 0 && (<div className="flex items-center gap-3">
        ...
        ].map(({ key, label }) => (<button key={key} onClick={() => onTabChange(key)} className={`px-3 sm:px-6 py-2 sm:py-3 font-medium text-xs sm:text-sm transition-colors rounded-md flex-1 sm:flex-none ${activeTab === key
          ...
          <div className="bg-white rounded-xl shadow-sm">
            <div className="p-6">
              ...
              {activeTab === 'notes' && (<NotesSection contactId={contactId} userId={userId}/>)}

              {activeTab === 'actions' && (<ActionsSection contactId={contactId} userId={userId}/>)}

              {activeTab === 'preferences' && (<PreferencesSection contactId={contactId} userId={userId}/>)}

              {activeTab === 'moments' && (<ContactMomentsFeed contactId={contactId} userId={userId}/>)}
            </div>
          </div>
        </div>
      </div>
...
//# sourceMappingURL=ContactDetailView.js.map