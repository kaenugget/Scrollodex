...
export function UserConnectView({ shareToken }) {
    ...
    return (<div className="min-h-screen bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            {/* Connect Button */}
            {!connected && (<Card className="bg-gray-800 border-gray-700 p-6 text-center">
                ...
                <Button onClick={handleConnect} disabled={isConnecting || !currentUser} className="bg-emerald-600 hover:bg-emerald-700 text-white w-full">
                  {isConnecting ? (<div className="flex items-center gap-2">
                      <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"/>
                      Connecting...
                    </div>) : !currentUser ? ("Sign in to Connect") : (<>
            ...
            {connected && (<Card className="bg-emerald-900 border-emerald-700 p-6 text-center">
...
//# sourceMappingURL=UserConnectView.js.map