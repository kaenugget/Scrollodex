...
const formatDexNumber = (num) => `#${String(num).padStart(4, '0')}`;
export function DexCard({ dexEntry, contact, onView }) {
    return (<div className="scrollodex-card scrollodex-card-entrance hover:shadow-lg transition-shadow duration-200 overflow-hidden">
      <div className="p-4 sm:p-6">
        ...
        {/* View Button */}
        <button onClick={() => onView(contact._id)} className="w-full py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors">
          Open Entry
        </button>
      </div>
...
export const DexCardSkeleton = () => {
    return (<div className="scrollodex-card overflow-hidden">
...
//# sourceMappingURL=DexCard.js.map