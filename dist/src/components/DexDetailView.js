...
export function DexDetailView({ contactId, userId }) {
    ...
    return (<div className="max-w-6xl mx-auto p-4 sm:p-6">
      {/* Header */}
      <div className="flex items-center gap-4 mb-4 sm:mb-6">
        <button onClick={handleBack} className="p-2 hover:bg-neutral-800 transition-colors pixel-border-outset">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="space-y-6">
          ...
          <PixelFrame padding="p-6">
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-2 mb-6">
                {dexEntry.types.map(type => (<TypeChip key={type} type={type} size="md"/>))}
              </div>
          ...
          <PixelFrame padding="p-6">
            ...
            <div className="space-y-4">
              ...
              {dexEntry.level < 3 && (<div className="flex justify-between items-center">
        ...
        <div className="space-y-6">
          ...
          <PixelFrame padding="p-6">
            ...
            return (<div key={type} className={`p-2 text-center ${getEffectivenessColor(effectiveness)}`}>
...
//# sourceMappingURL=DexDetailView.js.map