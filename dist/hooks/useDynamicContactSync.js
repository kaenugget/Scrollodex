...
export function useDynamicContactSync(userId) {
    const syncAllDynamicContacts = useMutation(api.contacts.syncAllDynamicContacts);
    const dynamicContactsNeedingSync = useQuery(api.contacts.getDynamicContactsNeedingSync, userId ? { ownerId: userId } : "skip");
    useEffect(() => {
...
//# sourceMappingURL=useDynamicContactSync.js.map